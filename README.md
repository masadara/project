...
10. Функция вывода транзакций с JSON файла
11. Функция вывода суммы с конвертацией из USD и EUR в RUB
12. Функция вывода транзакций с XLSX файла
13. Функция вывода транзакций с CSV файла
